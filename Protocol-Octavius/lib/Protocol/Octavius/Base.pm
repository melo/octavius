...
#
# Borrowed by Pedro Melo, from Mojo::Base

package Protocol::Octavius::Base;
...
sub attr {
  ...
  for my $attr (@$attrs) {
    ...
    *{"${class}::$attr"} = eval $code;
    ...
    Carp::croak("Protocol::Octavius::Base compiler error: \n$code\n$@\n") if $@;
...
Protocol::Octavius::Base - A solid base for us all
...
This module is a copy of L<Mojo::Base>. I like it a lot so I just "re-used"
it.

L<Mojo::Base> is a universal base class containing simple
and fast helpers for object oriented Perl programming.
